...
#SRC_URI="http://download.cloud.secondlife.com/project-viewers/Materials/${MY_P}.tar.bz2"
SRC_URI="http://download.cloud.secondlife.com/projects/storm_materials-hotfix/SecondLife-i686-3.6.1.278007.tar.bz2"
RESTRICT="strip"
